...
public class Hover {
    ...
    public static void addHoverEffectQuiz(Button button1, Button button2, Button button3, Button button4, Circle bulat1, Circle bulat2, Circle bulat3, Circle bulat4, Text text1,Text text2,Text text3,Text text4) {
        ...
        button1.setOnMouseEntered(e -> {
            ...
            button1.setStyle("-fx-background-color: #e74c3c; -fx-background-radius :  18px; -fx-border-radius :  18px; -fx-text-fill: #fffffff; -fx-alignment: left center;");
        });
        button1.setOnMouseExited(e -> {
            button1.setEffect( shadow);
            bulat1.setFill(Paint.valueOf("#e74c3c"));
            text1.setFill(Paint.valueOf("#ffffff"));
            button1.setStyle("-fx-background-color:  #fffffff; -fx-background-radius:  18px; -fx-border-radius:  18px; -fx-text-fill: #333333; -fx-alignment: left center;");
        });
        ...
        button2.setOnMouseEntered(e -> {
            ...
            button2.setStyle("-fx-background-color: #2ecc71; -fx-background-radius :  18px; -fx-border-radius :  18px; -fx-text-fill: #fffffff; -fx-alignment: left center;");
        });
        button2.setOnMouseExited(e -> {
            button2.setEffect( shadow);
            bulat2.setFill(Paint.valueOf("#2ecc71"));
            text2.setFill(Paint.valueOf("#ffffff"));
            button2.setStyle("-fx-background-color:  #fffffff; -fx-background-radius:  18px; -fx-border-radius:  18px; -fx-text-fill: #333333; -fx-alignment: left center;");
        });
        ...
        button3.setOnMouseEntered(e -> {
            ...
            button3.setStyle("-fx-background-color: #f1c40f; -fx-background-radius :  18px; -fx-border-radius :  18px; -fx-text-fill: #fffffff; -fx-alignment: left center;");
        });
        button3.setOnMouseExited(e -> {
            button3.setEffect( shadow);
            bulat3.setFill(Paint.valueOf("#f1c40f"));
            text3.setFill(Paint.valueOf("#ffffff"));
            button3.setStyle("-fx-background-color:  #fffffff; -fx-background-radius:  18px; -fx-border-radius:  18px; -fx-text-fill: #333333; -fx-alignment: left center;");
        });
        ...
        button4.setOnMouseEntered(e -> {
            ...
            button4.setStyle("-fx-background-color: #3498db; -fx-background-radius :  18px; -fx-border-radius :  18px; -fx-text-fill: #fffffff; -fx-alignment: left center;");
        });
        button4.setOnMouseExited(e -> {
            button4.setEffect( shadow);
            bulat4.setFill(Paint.valueOf("#3498db"));
            text4.setFill(Paint.valueOf("#ffffff"));
            button4.setStyle("-fx-background-color:  #fffffff; -fx-background-radius:  18px; -fx-border-radius:  18px; -fx-text-fill: #333333; -fx-alignment: left center;");
        });
